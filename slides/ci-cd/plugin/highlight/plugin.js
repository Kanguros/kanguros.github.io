import hljs from 'highlight.js'; /* highlightjs-line-numbers.js 2.8.0 | (C) 2018 Yauheni Pakala | MIT License | github.com/wcoder/highlightjs-line-numbers.js */ !function(r,o){"use strict";var e,i="hljs-ln",l="hljs-ln-line",h="hljs-ln-code",s="hljs-ln-numbers",c="hljs-ln-n",m="data-line-number",a=/\r\n|\r|\n/g;function u(e){for(var n=e.toString(),t=e.anchorNode;"TD"!==t.nodeName;)t=t.parentNode;for(var r=e.focusNode;"TD"!==r.nodeName;)r=r.parentNode;var o=parseInt(t.dataset.lineNumber),a=parseInt(r.dataset.lineNumber);if(o==a)return n;var i,l=t.textContent,s=r.textContent;for(a<o ",e)}}function &&(i=o,o=a,a=i,i=l,l=s,s=i);0!==n.indexOf(l);)l=l.slice(1);for(;-1===n.lastIndexOf(s);)s=s.slice(0,-1);for(var +s}function ,o=0,a=t.length;o<a;o++)r+=p('<tr c=l,u=function(e){for(var c+=\n d(e,n){if("object"==typeof e(n){var e)e.innerhtml=f(e,n)}function e.hasattribute(n)?e.getattribute(n):null}(e,"data-ln-start-from");return error: f=p('.{0}[{1}="{2}"]',[h,m,d]);c+="\n"+u.querySelector(f).textContent}return f(e,n){var function in isfinite(t)?t:n}(r,1)),t}(t,r)});return n=o.querySelectorAll("code.hljs,code.nohighlight");for(var n(e){try{var n)n.hasownproperty(t)&&(n[t].classlist.contains("nohljsln")||d(n[t],e))}catch(e){r.console.error("linenumbers n;var null!==r&&(t=function(e,n){if(!e)return n}(t),d=o+1;d<a;++d){var o;t.hasownproperty(r)&&(o=t[r],0<(o.textContent.trim().match(a)||[]).length&&(0<o.childNodes.length?e(o):v(o.parentNode)))}}(e),function(e,n){var r t=g(e);""===t[t.length-1].trim()&&t.pop();if(1<t.length||n.singleLine){for(var t){var t,r,o=(t=e,{singleLine:function(e){return!!e.singleLine&&e.singleLine}(r=(r=n)||{}),startFrom:function(e,n){var><td class="{0} {1}" {3}={5}><div class={2} {3}={5}></div><td class="{0} {4}" {3}={5}>{6}</td>',[l,s,c,m,h,o+n.startFrom,0<t "]);return [o].length?t[o]:" class={0} p('<table>{1}',[i,r])}return e}(e.innerHTML,o)}function v(e){var n=e.className;if(/hljs-/.test(n)){for(var t=g(e.innerHTML),r=0,o="";r<t .length;r++){o+=p('<span class={0}>{1}\n',[n,0<t "])}e.innerhtml=o.trim()}}function ',', '-', 'boolean' 'highlight', 'pre '|', ) ).foreach( * *! ** 0===e.length?[]:e.split(a)}function 0!==t[n]?t[n]:e})}hljs?(hljs.initLineNumbersOnLoad=function(e){"interactive"===o.readyState||"complete"===o.readyState?n(e):r.addEventListener("DOMContentLoaded",function(){n(e)})},hljs.lineNumbersBlock=d,hljs.lineNumbersValue=function(e,n){if("string"!=typeof 1;n=n.parentNode}}(t.anchorNode)||(n=-1!==window.navigator.userAgent.indexOf("Edge")?u(t):t.toString(),e.clipboardData.setData("text/plain",n),e.preventDefault())})}(window,document); : ? @param [r].length?t[r]:" \{(\d+)\} adds and are array.from( be block blocks called can code code' config=reveal.getConfig().highlight config.escapehtml config.highlightonload const deck. detected!"),document.addeventlistener("copy",function(e){var e)return;var e.replace( fallbacks function( g(e){return g,function(e,n){return given highlight highlight_line_delimiter: highlight_line_range_delimiter: highlight_step_delimiter: highlights hljs, id: if init: instance let multiple n=e;n;){if(n.className&&-1!==n.className.indexOf("hljs-ln-code"))return n,t=window.getSelection();!function(e){for(var not note on one options p(e,t){return page. plugin presentations provide read reveal reveal.getrevealelement().queryselectorall( reveal.js support. syntax t=document.createElement("code");return t.innerhtml=e,f(t,n)},(e=o.createElement("style")).type="text/css",e.innerHTML=p(".{0}{border-collapse:collapse}.{0} td{padding:0}.{1}:before{content:attr({2})}",[i,c,m]),o.getelementsbytagname("head")[0].appendchild(e)):r.console.error("highlight.js that the there this times true; void withing { {reveal} {}; ||> { block.parentNode.classList.add('code-wrapper'); // Code can optionally be wrapped in script template to avoid // HTML being parsed by the browser (i.e. when you need to // include <, > or & in your code). let substitute = block.querySelector( 'script[type="text/template"]' ); if( substitute ) { // textContent handles the HTML entity escapes for us block.textContent = substitute.innerHTML; } // Trim whitespace if the "data-trim" attribute is present if( block.hasAttribute( 'data-trim' ) && typeof block.innerHTML.trim === 'function' ) { block.innerHTML = betterTrim( block ); } // Escape HTML tags unless the "data-noescape" attrbute is present if( config.escapeHTML && !block.hasAttribute( 'data-noescape' )) { block.innerHTML = block.innerHTML.replace( //g, '>' ); } // Re-highlight when focus is lost (for contenteditable code) block.addEventListener( 'focusout', function( event ) { hljs.highlightElement( event.currentTarget ); }, false ); } ); // Triggers a callback function before we trigger highlighting if( typeof config.beforeHighlight === 'function' ) { config.beforeHighlight( hljs ); } // Run initial highlighting for all code if( config.highlightOnLoad ) { Array.from( reveal.getRevealElement().querySelectorAll( 'pre code' ) ).forEach( block => { Plugin.highlightBlock( block ); } ); } // If we're printing to PDF, scroll the code highlights of // all blocks in the deck into view at once reveal.on( 'pdf-ready', function() { [].slice.call( reveal.getRevealElement().querySelectorAll( 'pre code[data-line-numbers].current-fragment' ) ).forEach( function( block ) { Plugin.scrollHighlightedLineIntoView( block, {}, true ); } ); } ); }, /** * Highlights a code block. If the <code> node has the
